        ...
        <Segment>
            ...
            <>
                ...
                <Formik initialValues = { {
                    newPassword1: '',
                    newPassword2: '' } } validationSchema = { Yup.object({
                    ...
                    { ({ errors, isSubmitting, isValid, dirty }) => (
                        <Form className = 'ui form'>
                            ...
                            <Button style = { { display: 'block' } } type = 'submit' disabled = { !isValid || isSubmitting || !dirty } loading = { isSubmitting } size = 'large' positive content = 'Update Password'/>
                        </Form>
                    )}
                </Formik>
            </> }
            ...
            <>
                ...
                <Button icon = 'facebook' color = 'facebook.com' as = { Link } to = 'https://facebook.com' content = 'Go to Facebook'/>
            </> }
