...
export default function EventDetailedHeader({ event, isHost, isGoing }) {
    ...
    async function handelUserJoinEvent() {
        setLoading(true);
    ...
    async function handelUserLeaveEvent() {
        setLoading(true);
        ...
        <>
            ...
            <Segment.Group>
                ...
                <Segment attached = "bottom" clearing>
                    { !isHost && <>
                        { isGoing ? (
                            <Button onClick = { handelUserLeaveEvent }>Cancel My Place</Button>
                        ) : (
                            <Button onClick = { authenticated ? handelUserJoinEvent : () => setModalOpen(true) } loading = { loading } color = "teal">JOIN THIS EVENT</Button>
                        ) }
                    </> }
